...
export const AccessDenied: React.FC = () => {
    ...
    return (
        <div className="min-h-[60vh] flex flex-col items-center justify-center text-center p-6">
            <div className="bg-[#DC2626]/10 dark:bg-[#7F1D1D]/20 p-6 rounded-full mb-6">
                <ShieldAlert className="w-16 h-16 text-[#DC2626] dark:text-[#DC2626]" />
            </div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">عذراً، ليس لديك صلاحية الوصول</h1>
            <p className="text-gray-500 dark:text-hrsd-cool-gray mb-8 max-w-md">
