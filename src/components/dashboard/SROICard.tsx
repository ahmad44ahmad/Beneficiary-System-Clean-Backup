...
export const SROICard: React.FC = () => {
    ...
    return (
        <div className="bg-gradient-to-br from-indigo-900 to-purple-900 rounded-xl p-6 text-white overflow-hidden relative shadow-lg" dir="rtl">
            ...
            <div className="mt-6 grid grid-cols-2 gap-8 relative z-10">
                ...
                <div className="border-e border-indigo-700 pe-8">
                    <p className="text-indigo-300 text-xs uppercase tracking-wider mb-2">القيمة الاجتماعية المولَّدة</p>
            ...
            <div className="mt-6 pt-6 border-t border-indigo-800/50 text-xs text-indigo-300/80 relative z-10 leading-relaxed">
