                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  ...
                  ${item.status === 'processed' ? 'bg-[#269798]/15 text-[#1B7778]' : 'bg-[#FCB614]/10 text-[#D49A0A]'}`}>
                                ...
                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    <button className="text-[#269798] hover:text-[#0F3144]"><MoreVertical size={18} /></button>
                                </td>
                            </tr>
                        ))}
                </tbody>
                    ...
                    <div className="border-t pt-4">
                        ...
                        <ul className="space-y-2">
                            ...
                            {meeting.actionItems.length > 2 && (
                                <li className="text-xs text-[#269798] text-center cursor-pointer">
        ...
        <div className="p-6 max-w-7xl mx-auto space-y-6">
            ...
            <div className="relative">
                ...
                <input
                    ...
                    className="w-full ps-4 pe-10 py-2 border rounded-lg focus:ring-2 focus:ring-[#269798] focus:border-[#269798]"
                    value={searchTerm}
