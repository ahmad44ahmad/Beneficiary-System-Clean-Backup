        ...
        <div className="max-w-3xl mx-auto p-6 animate-in fade-in slide-in-from-bottom-4 duration-500" dir="rtl">
            ...
            <Card className="p-8 shadow-lg border-t-4 border-t-red-500">
                {step === 1 && (
                    <div className="space-y-6">
                        <div>
                            ...
                            <textarea
                                className="w-full h-32 p-4 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#DC2626] focus:border-[#DC2626] transition-all font-sans"
                        ...
                        <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-xl border border-gray-200">
                            <EyeOff className={`w-6 h-6 ${formData.isAnonymous ? 'text-[#269798]' : 'text-gray-400'}`} />
                    ...
                    <div className="text-center space-y-6">
                        <div className="bg-[#269798]/10 p-6 rounded-2xl border border-[#269798]/10">
                            ...
                            <div className="space-y-2 text-sm text-[#1B7778] text-right">
                                ...
                                <p className="mt-4 p-3 bg-white/50 rounded-lg border border-[#269798]/10 text-gray-700">
                ...
                {step === 1 && !formData.description && (
                    <p className="text-[#DC2626] text-xs mt-2 opacity-0 animate-pulse" id="error-msg">يرجى وصف الحادث</p>
                )}
