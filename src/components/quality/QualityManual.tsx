    ...
    subsections: [
      {
        ...
        content: [
          ...
          'السياق التشغيلي: إدارة 132 عملية متداخلة بين قطاعات طبية واجتماعية وتأهيلية',
      ...
      },
      {
        ...
        content: [
          'تم تحديد 132 عملية تشغيلية مصنفة إلى: عمليات أساسية، عمليات داعمة، عمليات إدارية',
    ...
    subsections: [
      {
        ...
        content: [
          '132 عملية تشغيلية موثقة ومصنفة',
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="relative">
              <Search className="absolute end-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-500" />
              <input
                type="text"
