    ...
    return (
        <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-[#2BB574]/10 font-readex" dir="rtl">
            ...
            <form onSubmit={handleSubmit} className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                className="w-full p-2 border rounded-lg focus:ring-2 focus:ring-[#2BB574] outline-none hover:border-[#2BB574] transition-colors"
                            />
                        </div>
                        <div>
                ...
                <div className="space-y-4">
                    <h3 className="text-lg font-bold text-gray-800 flex items-center gap-2 border-b pb-2">
                        <User className="h-5 w-5 text-[#269798]" />
                        التقييم العام
                    </h3>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="col-span-2">
                            ...
                            <select
                                ...
                                value={formData.mood}
                                onChange={handleChange}
                                className="w-full p-2 border rounded-lg focus:ring-2 focus:ring-[#2BB574] outline-none"
                            >
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            onChange={handleChange}
                            className="w-full p-2 border rounded-lg h-24 focus:ring-2 focus:ring-[#2BB574] outline-none resize-none"
                ...
                {/* Incidents & Followup */}
                <div className="md:col-span-2 bg-[#DC2626]/10 p-4 rounded-lg border border-[#DC2626]/10">
                    <div className="flex items-center gap-2 mb-2 text-[#7F1D1D] font-bold">
                    ...
                    <div className="space-y-3">
                        <textarea
                            ...
                            onChange={handleChange}
                            className="w-full p-2 border rounded-lg h-16 focus:ring-2 focus:ring-[#DC2626] outline-none resize-none bg-white"
