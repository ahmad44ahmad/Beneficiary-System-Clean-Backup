            ...
            <main className="flex-1 space-y-8 print:w-full print:p-0">
                ...
                <section id="exec-summary" className="bg-white rounded-xl p-8 shadow-sm border border-gray-100 scroll-mt-24">
                    ...
                    <div className="prose max-w-none text-gray-700 leading-relaxed space-y-4">
                        ...
                        <div className="bg-[#DC2626]/10 border-e-4 border-[#DC2626] p-4 rounded-l-lg">
                            <p className="text-[#7F1D1D] font-medium">كشف المسح العميق (Deep Dive) للملفات التشغيلية، وتحديداً في مراكز التأهيل الشامل، عن فجوة جوهرية.</p>
                ...
                <section id="strategic-context" className="bg-white rounded-xl p-8 shadow-sm border border-gray-100 scroll-mt-24">
                    <div className="flex items-center gap-3 mb-6">
                        <div className="w-10 h-10 rounded-lg bg-[#269798]/10 flex items-center justify-center text-[#0F3144] font-bold text-xl">2</div>
                ...
                <section id="deep-diagnosis" className="bg-white rounded-xl p-8 shadow-sm border border-gray-100 scroll-mt-24">
                    ...
                    <div className="space-y-6">
                        <div className="flex gap-4 p-4 border rounded-lg bg-white hover:shadow-md transition-shadow">
                            <Activity className="w-8 h-8 text-[#269798] flex-shrink-0" />
                            <div>
                        ...
                        <div className="flex gap-4 p-4 border rounded-lg bg-white hover:shadow-md transition-shadow">
                            <Heart className="w-8 h-8 text-[#DC2626] flex-shrink-0" />
                            <div>
                ...
                <section id="theoretical-framework" className="bg-white rounded-xl p-8 shadow-sm border border-gray-100 scroll-mt-24">
                    <div className="flex items-center gap-3 mb-6">
                        <div className="w-10 h-10 rounded-lg bg-[#0F3144]/10 flex items-center justify-center text-[#0A2030] font-bold text-xl">4</div>
                        ...
                        <table className="w-full text-sm text-right border-collapse">
                            <thead>
                                <tr className="bg-gray-50 text-gray-900 border-b-2 border-primary">
                                    ...
                                    <th className="p-4 font-bold bg-[#269798]/10">ISO 9001 (الجودة)</th>
                                    <th className="p-4 font-bold bg-[#2BB574]/10">ISO 45001 (السلامة)</th>
                                    <th className="p-4 font-bold bg-[#FCB614]/10">Mowaamah (التمكين)</th>
                                </tr>
                            </thead>
                ...
                <section id="roadmap" className="bg-white rounded-xl p-8 shadow-sm border border-gray-100 scroll-mt-24">
                    ...
                    <div className="space-y-8 relative before:absolute before:inset-0 before:ms-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-slate-300 before:to-transparent">
                        ...
                        <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                            <div className="flex items-center justify-center w-10 h-10 rounded-full border border-white bg-slate-300 group-[.is-active]:bg-[#2BB574] text-hrsd-cool-gray group-[.is-active]:text-[#2BB574]/10 shadow shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2">
                                1
                            </div>
                            <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-white p-4 rounded border border-gray-200 shadow">
                                <div className="flex items-center justify-between space-x-2 mb-1">
                                    <div className="font-bold text-hrsd-navy">المرحلة الأولى: التأسيس والتوافق</div>
                                    <time className="font-caveat font-medium text-[#0F3144]">الشهور 1-8</time>
                                </div>
                                <div className="text-hrsd-cool-gray text-sm">
                        ...
                        {/* Phase 2 */}
                        <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                            <div className="flex items-center justify-center w-10 h-10 rounded-full border border-white bg-slate-300 group-[.is-active]:bg-[#269798] text-hrsd-cool-gray group-[.is-active]:text-[#2BB574]/10 shadow shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2">
                                2
                            </div>
                            <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-white p-4 rounded border border-gray-200 shadow">
                                <div className="flex items-center justify-between space-x-2 mb-1">
                                    <div className="font-bold text-hrsd-navy">المرحلة الثانية: التحول الرقمي وإعادة الهندسة</div>
                                    <time className="font-caveat font-medium text-[#0F3144]">الشهور 9-16</time>
                                </div>
                                <div className="text-hrsd-cool-gray text-sm">
                        ...
                        {/* Phase 3 */}
                        <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                            <div className="flex items-center justify-center w-10 h-10 rounded-full border border-white bg-slate-300 group-[.is-active]:bg-[#FCB614] text-hrsd-cool-gray group-[.is-active]:text-[#2BB574]/10 shadow shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2">
                                3
                            </div>
                            <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-white p-4 rounded border border-gray-200 shadow">
                                <div className="flex items-center justify-between space-x-2 mb-1">
                                    <div className="font-bold text-hrsd-navy">المرحلة الثالثة: التميز وقياس الأثر</div>
                                    <time className="font-caveat font-medium text-[#0F3144]">الشهور 17-24</time>
                                </div>
                                <div className="text-hrsd-cool-gray text-sm">
