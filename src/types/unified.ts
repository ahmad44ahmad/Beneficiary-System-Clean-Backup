...
import { SocialCaseStudy, ClothingDistribution, ActivityParticipation } from './social';
...
export interface UnifiedBeneficiaryProfile extends Beneficiary {
    ...
    activeRehabPlan?: RehabPlan | (Record<string, unknown> & { status?: string }); // Union to allow legacy RehabilitationPlan
    ...
    social?: {
        ...
        clothingDistributions: ClothingDistribution[];
        activityLog: ActivityParticipation[];
    };
}
