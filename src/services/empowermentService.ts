...
const DEMO_PREFERENCES: Record<string, BeneficiaryPreferences> = {
    ...
    '172': {
        ...
        what_makes_me_happy: 'الجلوسُ في الشمس قبل الغروب، وسماعُ القرآن، ووجودُ الزملاء حولي، وتقديرُ جهدي في تعلّم الإمساك بكوب الماء.',
        what_makes_me_upset: 'الأصواتُ العالية بعد العصر، وتأخُّر موعد الصلاة، والتعجّلُ في تنفيذ روتيني اليومي.',
        my_dreams: 'أن أستقلَّ في إمساك كوب الماء وتناول الطعام دون مساعدة، وأن أشاركَ مشاركةً كاملةً في صلاة الجماعة.',
        wake_up_time: '05:00',
        sleep_time: '22:00',
    },
};
