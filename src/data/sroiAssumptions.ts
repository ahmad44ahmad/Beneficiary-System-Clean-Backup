...
export const SROI_ASSUMPTIONS = {
    ...
    /** نسبة الادّخار من تكلفة المستفيد عند نجاح خطة التأهيل (مُعاد ضبطه 2026-04-28 لمواءمة 1.80×) */
    costSavingsPerSuccess: 0.58,
    ...
    /** نسبة نجاح خطة التأهيل (مُعاد ضبطه 2026-04-28) */
    rehabSuccessRate: 0.50,

    /** نسبة المستفيدين الذين يلتحقون بسوق العمل بعد التأهيل (مُعاد ضبطه 2026-04-28) */
    employmentRate: 0.20,
