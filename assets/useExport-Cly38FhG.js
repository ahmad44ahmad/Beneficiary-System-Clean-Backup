import{r as m}from"./vendor-react-UAjZvo6e.js";function S(){const[r,o]=m.useState(!1),l=m.useCallback((s={})=>{o(!0),setTimeout(()=>{window.print(),o(!1)},100)},[]),p=m.useCallback((s,i,e={})=>{o(!0);const{title:t="تقرير",subtitle:n,orientation:d="portrait"}=e,a=`
<!DOCTYPE html>
